...
##' @param thousands_sep
##' @param dec_mark
DTtables_rate <- function(dat = dtCast(), pretty_vars = prettyVariable(),
                          percent_rate = selectPercentOrRate(), pretty_ag_lv =
                          prettyAggr_level(), ui_sex_levels = ui_sex_levels,
                          plot_title = plotTitle(), pretty_var_singular =
                          prettyVariableSingular(), is_kom = isKom(),
                          thousands_sep = thousands_sep, dec_mark = dec_mark) {
